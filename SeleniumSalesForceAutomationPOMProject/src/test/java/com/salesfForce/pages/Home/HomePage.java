...
public class HomePage extends BasePage{
	...
	@FindBy(xpath ="(//select[@id='duel_select_1'])[1]") WebElement selectTab;
	...
	public boolean selectFromCustomizedTabAndRemove()
	{
	 ...
	 public void logOutNLoginFromCustom()
	 {
	 waitUntilVisible(userloginLink);
		clickElement(userloginLink);
		report.logTestInfo("userloginLink is clicked");
	...
	public boolean firstNlastPageHomePage() 
	{
		...
		clickElement(firstAndLastName);
		
		String FAndLNamePage=driver.getTitle();
		report.logTestInfo("title of FNL Name is"+FAndLNamePage);
	...
	public boolean verifyTitleOfTheHomePageAndUserAccount() {
		...
		System.out.println("titile of home page is correct="+result);
		return result;
